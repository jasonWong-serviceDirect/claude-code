...
```
/pr-review-toolkit:best-practices Is this the right way to handle auth in Next.js?

/pr-review-toolkit:best-practices React state management in this component

/pr-review-toolkit:best-practices TypeScript error handling patterns

/pr-review-toolkit:best-practices Am I using React hooks correctly here?
```
